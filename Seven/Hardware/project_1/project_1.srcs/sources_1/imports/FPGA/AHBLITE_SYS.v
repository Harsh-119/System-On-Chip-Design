...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Interrupt signals
        ...
        wire          timer_irq;
        wire          gpio_irq;
        assign        irq = {29'b0,timer_irq,uart_irq,gpio_irq}; //concatenating the irqs from differeny peripherals to main 32-bit irq signal. 
    // assign        LED[7] = lockup;
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////    
  ...
  // AHBLite VGA Controller  
    ...
    AHBGPIO uAHBGPIO(
        ...
        .GPIOOUT(LED[7:0]),
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////        
        .gpio_irq(gpio_irq)    //instantiating gpio_irq
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////        
    );

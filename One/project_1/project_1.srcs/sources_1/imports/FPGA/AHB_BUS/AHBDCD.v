...
begin
  ...
  case(HADDR[31:24])
    //MEMORY MAP --> 0x0000_0000 to 0x00FF_FFFF  16MB

    //MEMORY MAP --> 0x5000_0000 to 0x50FF_FFFF  16MB 

    //MEMORY MAP --> 0x5100_0000 to 0x51FF_FFFF  16MB

    //MEMORY MAP --> 0x5200_0000 to 0x52FF_FFFF  16MB

    //MEMORY MAP --> 0x5300_0000 to 0x53FF_FFFF  16MB 

    //MEMORY MAP --> 0x5400_0000 to 0x54FF_FFFF  16MB  

	//MEMORY MAP --> 0x5500_0000 to 0x55FF_FFFF  16MB 

    //MEMORY MAP --> 0x5600_0000 to 0x56FF_FFFF  16MB 

	//MEMORY MAP --> 0x5700_0000 to 0x57FF_FFFF  16MB

	//MEMORY MAP --> 0x5800_0000 to 0x58FF_FFFF  16MB 

...
HD_PWD='C:/Users/Student/Desktop/277a/one/ahbdcd/ahbdcd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AHBDCD.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AHBDCD.tcl

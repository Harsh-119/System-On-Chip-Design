...
HD_PWD='C:/Users/Student/Desktop/277a/one/ahbdcd/ahbdcd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AHBDCD.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AHBDCD.tcl -notrace

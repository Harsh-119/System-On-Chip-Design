...
HD_PWD='C:/Users/Student/Desktop/277a/four_final/Hardware/H_KANJI/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AHBLITE_SYS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AHBLITE_SYS.tcl
